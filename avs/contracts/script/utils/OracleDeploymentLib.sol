...
library OracleDeploymentLib {
    ...
    function deployAndUpgradeServiceManagerImpl(
        ...
        address oracleServiceManager = deployment.oracleServiceManager;
        address oracleServiceManagerImpl = address(
            new OracleServiceManager(
                core.avsDirectory,
                deployment.stakeRegistry,
